...
Startup Optimizer 0.2.0 deliberately makes the plugin simpler.

Instead of asking users to understand stages, reports, and sorting rules, this version focuses on one practical question: should this community plugin load at startup, load later, or stay disabled for now?
